...
_package-headers() {
  ...
  # add md/bcache headers
  mkdir -p "${pkgdir}/usr/lib/modules/${_kernver}/build/drivers/md/bcache"
  cp drivers/md/bcache/*.h "${pkgdir}/usr/lib/modules/${_kernver}/build/drivers/md/bcache"

  # add md/persistent-data headers
  mkdir -p "${pkgdir}/usr/lib/modules/${_kernver}/build/drivers/md/persistent-data"
  cp drivers/md/persistent-data/*.h "${pkgdir}/usr/lib/modules/${_kernver}/build/drivers/md/persistent-data"
